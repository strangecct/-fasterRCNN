...
class TwoMLPHead(nn.Module):
    ...
    Arguments:
        in_channels (int): number of input channels _也就是looling的out channels
...
class FastRCNNPredictor(nn.Module):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.cls_score = nn.Linear(in_channels, num_classes)  #分数预测，每个proposal预测类别
        self.bbox_pred = nn.Linear(in_channels, num_classes * 4)  #位置预测
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if rpn_anchor_generator is None:
            # _m 用这个试试 anchor_sizes = ((32,), (64,), (128,), (16,), (512,))
            anchor_sizes = ((32,), (64,), (128,), (256,), (512,)) #3 *5 个anchor
            aspect_ratios = ((0.5, 1.0, 2.0),) * len(anchor_sizes) #重复五遍，有五层特征
        ...
        rpn = RegionProposalNetwork(
            ...
            rpn_fg_iou_thresh, rpn_bg_iou_thresh,  # 0.5， 0.5
            rpn_batch_size_per_image, rpn_positive_fraction,  # 512 0.25
        ...
        roi_heads = RoIHeads(
            ...
            box_batch_size_per_image, box_positive_fraction,  # 512  0.25 rpn提供了2000个proposal只采用一部分
            bbox_reg_weights,
            box_score_thresh, box_nms_thresh, box_detections_per_img)  # 0.05  0.5  100 最终预测时后处理
